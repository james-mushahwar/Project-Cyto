...
namespace _Scripts._Game.AI.MovementStateMachine.Bosses.GigaBombDroid{
    ...
    public abstract class GigaBombDroidBaseAIMovementState : BossBaseAIMovementState
    {
        protected GigaBombDroidAIMovementStateMachine _gbdCtx;
        protected GigaBombDroidAIEntity _gbdEntity;

        protected GigaBombDroidBaseAIMovementState(AIMovementStateMachineBase ctx, AIMovementStateMachineFactory factory) : base(ctx, factory)
        {
